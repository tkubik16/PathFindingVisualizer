...
public:
	...
	void DrawContentBox(std::string name, Texture2D& texture, glm::vec2 position, bool wireframe, glm::vec2 size, glm::vec2 scrolledDistance, float rotate = 0.0f, glm::vec3 color = glm::vec3(1.0f));
