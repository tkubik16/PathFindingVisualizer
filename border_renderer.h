...
public:
	...
	~BorderRenderer();
	void DrawBox(Texture2D& texture, glm::vec2 borderPosition, glm::vec2 borderSize, glm::vec2 topLeft, glm::vec2 topRight, glm::vec2 bottomLeft, glm::vec2 bottomRight, float radius, glm::vec2 screenSize, glm::vec2 scrolledDistance, float rotate = 0.0f, glm::vec3 color = glm::vec3(1.0f));
